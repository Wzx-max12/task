...
public class UserController {
    ...
    public Result<Map<String, Object>> getSummary() {
        ...
        summary.put("total", userService.getTotalCount());
        summary.put("active", userService.getActiveCount());
        summary.put("inactive", userService.getTotalCount() - userService.getActiveCount());
        summary.put("recentWeek", userService.getRecentWeekCount());
